"""EUR/USD Trend Following strategy for BacktesterV2.

EMA20/50 crossover + ADX>25 trend filter + RSI 45-75 momentum band.
ATR-based stop-loss and take-profit for volatility-adaptive exits.
"""
...
class EURUSDTrend(StrategyBase):
    """EUR/USD trend following with EMA crossover, ADX filter, RSI band."""
