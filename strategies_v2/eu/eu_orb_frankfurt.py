"""EU Opening Range Breakout Frankfurt strategy for BacktesterV2.

Hypothesis: The first 30 minutes of the Frankfurt session (09:00-09:30 CET)
establish a range defined by overnight order flow, institutional pre-market
positioning, and US futures settlement. Breakouts from this range with above-
average volume signal directional conviction that tends to follow through
during the European morning session.

Entry rules (London/Frankfurt overlap 09:30-12:00 CET = 08:30-11:00 UTC):
...
Expected: ~10-15 trades/month, win rate 45-55%, Sharpe 0.8-1.5
"""
...
class EUORBFrankfurt(StrategyBase):
    """Opening Range Breakout on DAX — first 30 min Frankfurt session range."""
